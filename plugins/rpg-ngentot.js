let handler = async (m, { conn, usedPrefix }) => {
  ...
  if (new Date() - global.db.data.users[m.sender].lastngewe > 1) {
    ...
    let rokit = `📲 Orderan Masuk dari [ Om hanma ]

ᴋᴀᴍᴜ ᴅᴀɴ ᴏᴍ hanma ᴍᴇᴍʙᴏᴏᴋɪɴɢ ʜᴏᴛᴇʟ
▒▒[ᴏʏᴏ]▒▒
▒▒▄▄▄▒▒ Kalian Berdua Masuk Ke kamar
▒█▀█▀█▒ kamu Membuka bh mu
░█▀█▀█░ Tete Mu diremas oleh om hanma
░█▀█▀█░  ( . )( . )
███████.  | 🤚 |
...
`.trim();
    ...
    let rokit4 = `Om hanma Memberimu Uang Lebih karena Goyanganmu Sangat unik 😝
`.trim();
